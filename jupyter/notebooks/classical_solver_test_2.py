...
"""
def create_random_node_points(number,Graph,lat_min,lat_max,lng_min,lng_max):
    node_list=[]
    lat_fac=lat_max-lat_min
    lng_fac=lng_max-lng_min
    for i in range(number):
        node_list.append(ox.distance.get_nearest_node(Graph,[lat_min+lat_fac*rng.random(),lng_min+lng_fac*rng.random()]))
    return node_list
"""
